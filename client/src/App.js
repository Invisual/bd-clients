        ...
        {this.props.loggedIn ? (
          <div className="app-container">
            ...
            <Switch>
              ...
              />
              <Route
                key="all-approvals-id"
                exact
                path="/approvals/:type/:id"
                render={props => (
                  <AllApprovalsContainer
                    openModal={this.props.openModal}
                    closeModal={this.props.closeModal}
              ...
              />
              <Route
                key="concluded-projects"
                exact
                path="/concludedprojects"
                render={props => (
                  <AllProjectsContainer
                    openModal={this.props.openModal}
                    closeModal={this.props.closeModal}
              ...
              />
              <Route
                key="concluded-projects-id"
                exact
                path="/concludedprojects/:id"
                render={props => (
                  <AllProjectsContainer
                    openModal={this.props.openModal}
                    closeModal={this.props.closeModal}
              ...
              <Route
                path="/admin"
                render={props => <GantTasksContainer {...props} />}
              />
              <Route
                exact
                path="/billing"
              ...
              />
              <Route
                key="create-task-in-project"
                exact
                path="/createtask/project/:project"
                render={props => (
                  <CreateTaskContainer
                    {...props}
                    type="add"
              ...
              <Route
                ...
                render={props => (
                  <CreateTripContainer
                    {...props}
                    type="edit"
                    title="Editar Deslocação"
                  />
                )}
              />
              <Route
                exact
                path="/approvevacations/:type/:id"
                render={props => <VacationsApprovalContainer {...props} />}
              />
              <Route
                exact
                path="/rejectvacations/:type/:id"
                render={props => <VacationsRejectContainer {...props} />}
              />
              <Route
                exact
                path="/regulation"
