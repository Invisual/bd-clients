        ...
        {this.props.loggedIn ? (
          <div className="app-container">
            ...
            <Switch>
              ...
              <Route key="both-tasks" exact path="/bothtasks" render={ props => <AllTasksContainer seeBothTasks={true} openModal={this.props.openModal} closeModal={this.props.closeModal} isShare={false} userInfo={this.props.userInfo} {...props} activeHours={this.props.activeHours} getActiveHours={this.props.getActiveHours} activeBudgetHours={this.props.activeBudgetHours} getActiveBudgetHours={this.props.getActiveBudgetHours}/> } />
              ...
              <Route key="all-budgets" exact path="/budgets" render={props => <AllBudgetsContainer isShare={false} userInfo={this.props.userInfo} {...props}  activeHours={this.props.activeHours} getActiveHours={this.props.getActiveHours} activeBudgetHours={this.props.activeBudgetHours} getActiveBudgetHours={this.props.getActiveBudgetHours}/>} />
              <Route key="all-budgets-id" exact path="/budgets/:id" render={props => <AllBudgetsContainer isShare={true} userInfo={this.props.userInfo} {...props} activeHours={this.props.activeHours} getActiveHours={this.props.getActiveHours} activeBudgetHours={this.props.activeBudgetHours} getActiveBudgetHours={this.props.getActiveBudgetHours}/>} />
              ...
              <Route key="create-task" exact path="/createtask" render={props => <CreateTaskContainer {...props} type="add" title="Nova Tarefa"/>} />
              <Route key="create-task-edit" exact path="/createtask/:id" render={props => <CreateTaskContainer {...props} type="edit" title="Editar Tarefa"/>} />
              <Route key="create-task-in-project" exact path="/createtask/project/:project" render={props => <CreateTaskContainer {...props} type="add" hasProject={true} title="Editar Tarefa"/>} />
