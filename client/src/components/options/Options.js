              ...
              props.placeholder ? (
                ...
                <div className="grid-widget tasks-options">
                  ...
                  <div className="options-actions">
                    {(props.userRole === 0 || props.userRole === 1) && (
                      <div className="tooltip-container action-clientinfo">
                        <Link
                          to={`createclientinfo/${props.clientContent.details[0].id_client}`}
                        >
                          <FiBook className="task-info-icon" />
                          <span className="tooltip">
                            Editar Infos de Cliente
                          </span>
                        </Link>
                      </div>
                    )}
                      ...
                      <>
                        <div className="tooltip-container action-delete">
                          <FiTrash2
                            ...
                            onClick={() => {
                              props.deleteActiveTask(
                                props.clientContent.details[0].id_client,
                        ...
                        <div className="tooltip-container action-edit">
                          <Link
                            to={`createclient/${props.clientContent.details[0].id_client}`}
                          >
              ...
              <div className="grid-widget tasks-options">
                {props.userRole === 1 && (
                  <div className="tooltip-container action-clientinfo">
                    ...
                    >
                      <FiBook className="task-info-icon" />
                      <span className="tooltip">Editar Infos de Cliente</span>
                    </Link>
                  </div>
                )}
              </div>
