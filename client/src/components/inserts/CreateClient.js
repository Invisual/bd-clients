    ...
    return (
        <InsertFormDiv>
            ...
            <div className="cards-container form-container">
                ...
                <form onSubmit={props.type === 'edit' ? props.editClient : props.insertClient}>
                    ...
                    <div className="grid-item">
                        <div className="input-wrapper">
                            <fieldset>
                                ...
                                <input type="number" onChange={props.changeHoursInput} placeholder="Inserir" value={props.type === 'edit' ? props.hoursInput : undefined}/>
                            </fieldset>
                        </div>
                    </div>
